...
export default function ExperienceCanvas({
  ...
  // Every visitor to this route is treated as a phone: that is what the route
  // is for, and the desktop file's sniff would otherwise hand a laptop
  // previewing this page a pixel ratio the layout was never composed at.
  const mobile = true;
  ...
  return (
    <Canvas
      ...
      // fov 56 and the arrival stop from MobileCameraRig, so the first frame
      // is already the pose the rig damps toward rather than a 42-degree
      // widescreen shot that snaps in.
      camera={{ fov: 56, near: 0.1, far: 70, position: [0, 1.75, 5.5] }}
